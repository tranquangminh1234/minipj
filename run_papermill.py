...
# LƯU Ý: Đặt là python3 nếu bạn chạy trong base environment
KERNEL = "python3"
...
print(">>> 2. Semi-supervised Data Prep...")
pm.execute_notebook(
...
print(">>> 3. Feature Prep (Supervised)...")
pm.execute_notebook(
...
print("\n=== ĐÃ CHẠY XONG TOÀN BỘ PIPELINE THÀNH CÔNG! ===")